...
<div class="addForm">
    ...
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <!--	<div class="input-group">-->
        <br>
        <label>News image</label><i style="font-size: 12px; color: #a94442"> *Uncheck if you're not adding news
            image.</i>
        <br><br>
        <input type="checkbox" name="confirmPicture" value="yes" checked/> Include picture<i
                style="font-size: 10px; color: #a94442"> *only png,jpeg,jpg</i>
        <br>
